...
public class RioVConsumable extends ItemFood{
	...
	public ItemStack onEaten(ItemStack itemStack, World world, EntityPlayer entityPlayer){
		if(itemStack.getItem().equals(RioVItems.blackDurii)){
			...
			entityPlayer.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 10 * 20, 2));// again,
																							// sets
																							// effect
																							// an
																							// time
		...
		if(itemStack.getItem().equals(RioVItems.blueMagicApple)){
			...
			entityPlayer.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 500, 3));// again,
																						// sets
																						// effect
																						// an
																						// time
