...
public class RioVBow extends ItemBow{
	...
	public static final String[] vravinite = new String[] {Util.MOD_ID + ":" + "vBow_pull_0", Util.MOD_ID + ":" + "vBow_pull_1",
			Util.MOD_ID + ":" + "vBow_pull_2"};
	public EntityDarknessArrow darknessArrow = new EntityDarknessArrow(null);
	public static final String[] wurTunBow = new String[] {Util.MOD_ID + ":" + "wBow_pull_0", Util.MOD_ID + ":" + "wBow_pull_1",
			Util.MOD_ID + ":" + "wBow_pull_2"};
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4){
		...
		if(this == RioVItems.vraviniteBow){
			if(flag || par3EntityPlayer.inventory.hasItem(RioVItems.vraviniteArrow)){
				...
				par2World.playSoundAtEntity(par3EntityPlayer, Sounds.bow.getPrefixedName(), 1.0F, 1.0F / (itemRand.nextFloat() * 0.4F + 1.2F) + f
						* 0.5F);
