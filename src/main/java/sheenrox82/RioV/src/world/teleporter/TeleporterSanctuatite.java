...
public class TeleporterSanctuatite extends Teleporter{
	...
	public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_){
		...
		if(this.destinationCoordinateCache.containsItem(j1)){
			TeleporterSanctuatite.PortalPosition portalposition = (TeleporterSanctuatite.PortalPosition) this.destinationCoordinateCache
					.getValueByKey(j1);
			d3 = 0.0D;
		...
		if(d3 >= 0.0D){
			if(flag){
				this.destinationCoordinateCache.add(j1,
						new TeleporterSanctuatite.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
