...
public class ChunkProviderBlindOasis implements IChunkProvider{
	...
	public void generateTerrain(int par1, int par2, Block[] par3BlockArray){
		...
		this.netherrackExclusivityNoise = this.netherrackExculsivityNoiseGen.generateNoiseOctaves(this.netherrackExclusivityNoise, par1 * 16,
	...
	public Chunk provideChunk(int par1, int par2){
		...
		BiomeGenBase[] abiomegenbase = this.worldObj.getWorldChunkManager().loadBlockGeneratorData((BiomeGenBase[]) null, par1 * 16, par2 * 16, 16,
				16);
