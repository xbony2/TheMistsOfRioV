		...
		if(this.attackTime <= 0 && par2 < 2.0F && par1Entity.boundingBox.maxY > this.boundingBox.minY
			...
			if(this.attackTime == 0){
				...
				if(this.field_70846_g > 1){
					...
					for(int i = 0; i < 1; ++i){
						EntitySmallFireball entitysmallfireball = new EntitySmallFireball(this.worldObj, this, d0 + this.rand.nextGaussian()
								* (double) f1, d1, d2 + this.rand.nextGaussian() * (double) f1);
