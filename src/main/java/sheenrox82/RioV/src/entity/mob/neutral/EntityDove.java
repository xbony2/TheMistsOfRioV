...
public class EntityDove extends EntityAmbientCreatureDeadBody{
	...
	protected void updateAITasks(){
		...
		if(this.currentFlightTarget == null || this.rand.nextInt(30) == 0
			...
			this.currentFlightTarget = new ChunkCoordinates((int) this.posX + this.rand.nextInt(7) - this.rand.nextInt(7), (int) this.posY
					+ this.rand.nextInt(6) - 2, (int) this.posZ + this.rand.nextInt(7) - this.rand.nextInt(7));
		}
