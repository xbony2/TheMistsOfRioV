...
public class RioVAPIUtil{
	 ...
	 * 
	 * @param itemName
	 *            - Object name in RioVItems.java (check Github).
	 */
	public Item getRioVItem(String itemName){
		try{
			...
			// you don't crash with this API in Eclipse because you don't have
			// the RioV source code.
	 ...
	 * 
	 * @param blockName
	 *            - Object name in RioVBlocks.java (check Github).
	 */
	 ...
	 *            - Object name in Enchantments.java (check Github).
	 */
	 ...
	 * 
	 * @param biomeName
	 *            - Object name in Biomes.java (check Github).
	 */
	 ...
	 * 
	 * @param soundName
	 *            - Object name in Sounds.java (check Github).
	 */
	 ...
	 * 
	 * @param field
	 *            - Field name in Config.java (check Github).
	 */
