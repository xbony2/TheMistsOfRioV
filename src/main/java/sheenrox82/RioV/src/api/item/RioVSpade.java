...
public class RioVSpade extends ItemSpade{
	...
	public void registerIcons(IIconRegister par1IconRegister){
		...
		if(RioVAPI.getInstance().natura){
			if(this == RioVAPI.getInstance().getUtil().getRioVItem("infusedBloodwoodShovel")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedGhostwoodShovel")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedDarkwoodShovel")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedFusewoodShovel")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedNetherquartzShovel"))
