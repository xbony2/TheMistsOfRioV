...
public class RioVAxe extends ItemAxe{
	...
	public void registerIcons(IIconRegister par1IconRegister){
		...
		if(RioVAPI.getInstance().natura){
			if(this == RioVAPI.getInstance().getUtil().getRioVItem("infusedBloodwoodAxe")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedGhostwoodAxe")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedDarkwoodAxe")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedFusewoodAxe")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedNetherquartzAxe"))
