...
public class RioVPickaxe extends ItemPickaxe{
	...
	public void registerIcons(IIconRegister par1IconRegister){
		...
		if(RioVAPI.getInstance().natura){
			if(this == RioVAPI.getInstance().getUtil().getRioVItem("infusedBloodwoodPickaxe")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedGhostwoodPickaxe")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedDarkwoodPickaxe")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedFusewoodPickaxe")
					|| this == RioVAPI.getInstance().getUtil().getRioVItem("infusedNetherquartzPickaxe"))
