...
public class ItemRenderNoFactionFlag implements IItemRenderer{
	@Override
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data){
		GL11.glPushMatrix();
		Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation(Util.MOD_ID + ":" + "textures/blocks/NoFactionFlag.png"));
		switch(type){
		case EQUIPPED:
