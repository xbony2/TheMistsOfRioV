...
public class RenderBossCore extends RenderLiving{
	...
	protected ResourceLocation getEntityTexture(Entity entity){
		if(entity instanceof EntityTerron)
			return RioVLib.terron;
		if(entity instanceof EntityDemonAngel)
			return RioVLib.demon_angel;
		if(entity instanceof EntityWoodElfKing)
