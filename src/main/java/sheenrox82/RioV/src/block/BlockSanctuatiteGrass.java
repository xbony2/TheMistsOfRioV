		...
		if(!p_149674_1_.isRemote){
			if(p_149674_1_.getBlockLightValue(p_149674_2_, p_149674_3_ + 1, p_149674_4_) < 4
				...
				for(int l = 0; l < 4; ++l){
					...
					if(p_149674_1_.getBlock(i1, j1, k1) == RioVBlocks.sanctuatiteGrass && p_149674_1_.getBlockMetadata(i1, j1, k1) == 0
							&& p_149674_1_.getBlockLightValue(i1, j1 + 1, k1) >= 4 && p_149674_1_.getBlockLightOpacity(i1, j1 + 1, k1) <= 2){
