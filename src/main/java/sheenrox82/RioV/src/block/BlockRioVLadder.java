...
public class BlockRioVLadder extends BlockLadder{
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		if(this == RioVBlocks.glimmerwoodLadder)
			this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "glimmerwoodLadder");
		if(this == RioVBlocks.cherryBlossomLadder)
			this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "cherryBlossomLadder");
		if(this == RioVBlocks.bloodLadder)
			this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "bloodLadder");
		if(this == RioVBlocks.skywoodLadder)
			this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "skywoodLadder");
	}
