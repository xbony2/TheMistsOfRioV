...
public class BlockRioVTrapDoor extends Block{
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_){
		if(!p_149695_1_.isRemote){
			...
			if(!(func_150119_a(p_149695_1_.getBlock(i1, p_149695_3_, j1)) || p_149695_1_.isSideSolid(i1, p_149695_3_, j1,
	...
	private static boolean func_150119_a(Block p_150119_0_){
		if(disableValidation)
			return true;
		return Material.air.isOpaque() && p_150119_0_.renderAsNormalBlock() || p_150119_0_ == Blocks.glowstone || p_150119_0_ instanceof BlockSlab
	...
	public void registerBlockIcons(IIconRegister iconRegister){
		if(this == RioVBlocks.glimmerwoodTrapdoor)
			this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "glimmerwoodTrapDoor");
		if(this == RioVBlocks.cherryBlossomTrapdoor)
			this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "cherryBlossomTrapDoor");
		if(this == RioVBlocks.bloodTrapdoor)
			this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "bloodTrapDoor");
		if(this == RioVBlocks.skywoodTrapdoor)
			this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + "skywoodTrapDoor");
	}
}
