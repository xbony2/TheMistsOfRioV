...
public class BlockRioVLeaf extends BlockLeavesBase{
	...
	public BlockRioVLeaf(){
		super(Material.leaves, true); // wow... I had it to false the whole
										// time, and I was wondering why the
										// leaves were fucking up...
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_){
		if(!p_149674_1_.isRemote){
			...
			if((l & 8) != 0 && (l & 4) == 0){
				...
				if(p_149674_1_.checkChunksExist(p_149674_2_ - i1, p_149674_3_ - i1, p_149674_4_ - i1, p_149674_2_ + i1, p_149674_3_ + i1, p_149674_4_
						+ i1)){
					int i2;
					int j2;
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random){
		if(par1World.canLightningStrikeAt(par2, par3 + 1, par4) && !World.doesBlockHaveSolidTopSurface(par1World, par2, par3 - 1, par4)
				...
				for(int var7 = par4 - 2; var7 <= par4 + 2; ++var7){
					...
					if(par5Random.nextInt(16) == 0){
						for(int var8 = par3; var8 <= par3 + 1; ++var8){
							...
							Particles.spawnParticle("glimmer", (double) par2 + 0.5D, (double) par3 + 1.0D, (double) par4 + 0.5D,
									(double) ((float) (par2) + par5Random.nextFloat()) - 0.5D,
									(double) ((float) (par3) - par5Random.nextFloat() - 1.0F),
									(double) ((float) (par4) + par5Random.nextFloat()) - 0.5D);
	...
	private void removeLeaves(World p_150126_1_, int p_150126_2_, int p_150126_3_, int p_150126_4_){
		this.dropBlockAsItem(p_150126_1_, p_150126_2_, p_150126_3_, p_150126_4_, p_150126_1_.getBlockMetadata(p_150126_2_, p_150126_3_, p_150126_4_),
				0);
