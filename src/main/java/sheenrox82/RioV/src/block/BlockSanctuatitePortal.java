...
public class BlockSanctuatitePortal extends BlockPortal{
	...
	public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity){
		if((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP))){
			...
			if(player.timeUntilPortal > 0){
				...
				player.timeUntilPortal = 300;
				player.mcServer.getConfigurationManager().transferPlayerToDimension(player, Config.sanctuatiteID,
						new TeleporterSanctuatite(player.mcServer.worldServerForDimension(Config.sanctuatiteID)));
			}else{
				player.timeUntilPortal = 300;
				player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0,
						new TeleporterSanctuatite(player.mcServer.worldServerForDimension(1)));
			}
	...
	public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_){
		if(p_149734_5_.nextInt(100) == 0){
			p_149734_1_.playSound((double) p_149734_2_ + 0.5D, (double) p_149734_3_ + 0.5D, (double) p_149734_4_ + 0.5D,
					Sounds.portal.getPrefixedName(), 0.5F, p_149734_5_.nextFloat() * 0.4F + 0.8F, false);
		}
	}
	...
	public static class Size{
		...
		protected int func_150858_a(){
			...
			for(this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g){
				...
				for(j = 0; j < this.field_150868_h; ++j){
					...
					if(j == 0){
						block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockSanctuatitePortal.field_150001_a[this.field_150865_b][0]], i,
								l + Direction.offsetZ[BlockSanctuatitePortal.field_150001_a[this.field_150865_b][0]]);
						
						if(block != Blocks.quartz_block){
							break label56;
						}
					}else if(j == this.field_150868_h - 1){
						block = this.field_150867_a.getBlock(k + Direction.offsetX[BlockSanctuatitePortal.field_150001_a[this.field_150865_b][1]], i,
								l + Direction.offsetZ[BlockSanctuatitePortal.field_150001_a[this.field_150865_b][1]]);
		...
		protected boolean func_150857_a(Block p_150857_1_){
			return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == RioVBlocks.sanctuatiteFire
					|| p_150857_1_ == RioVBlocks.sanctuatitePortal;
		}
