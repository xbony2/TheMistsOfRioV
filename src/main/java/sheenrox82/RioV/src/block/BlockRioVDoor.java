...
public class BlockRioVDoor extends BlockDoor{
	private static final String[] glimmerwoodDoor = new String[] {Util.MOD_ID + ":" + "glimmerwoodDoor_lower",
			Util.MOD_ID + ":" + "glimmerwoodDoor_upper"};
	private static final String[] cherryBlossomDoor = new String[] {Util.MOD_ID + ":" + "cherryBlossomDoor_lower",
			Util.MOD_ID + ":" + "cherryBlossomDoor_upper"};
