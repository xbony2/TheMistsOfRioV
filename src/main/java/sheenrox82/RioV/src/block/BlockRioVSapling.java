	...
	public void func_149878_d(World par1World, int par2, int par3, int par4, Random par5Random){
		if(this == RioVBlocks.glimmerwoodSapling){
			...
			if(l == 3){
				for(i1 = 0; i1 >= -1; --i1){
					for(j1 = 0; j1 >= -1; --j1){
						if(this.func_149880_a(par1World, par2 + i1, par3, par4 + j1, 3)
								&& this.func_149880_a(par1World, par2 + i1 + 1, par3, par4 + j1, 3)
								&& this.func_149880_a(par1World, par2 + i1, par3, par4 + j1 + 1, 3)
								&& this.func_149880_a(par1World, par2 + i1 + 1, par3, par4 + j1 + 1, 3)){
