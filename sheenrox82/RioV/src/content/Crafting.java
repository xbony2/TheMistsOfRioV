...
public class Crafting 
{
	...
	public static void add()
	{
		...
		GameRegistry.addRecipe(new ItemStack(RioVItems.terronCrystal, 1), "XZX", "ZAZ", "XZX", 'X', RioVItems.onyx, 'A', RioVItems.baseCrystal, 'Z', RioVItems.blindonite);
		GameRegistry.addRecipe(new ItemStack(RioVItems.demonAngelCrystal, 1), "XZX", "ZAZ", "XZX", 'X', RioVItems.onyx, 'A', RioVItems.baseCrystal, 'Z', RioVItems.nironite);
		...
		GameRegistry.addRecipe(new ItemStack(RioVItems.theDarknessCrystal, 1), "XZX", "ZAZ", "XZX", 'X', RioVItems.onyx, 'A', RioVItems.baseCrystal, 'Z', RioVItems.vulron);
		...
		GameRegistry.addRecipe(new ItemStack(RioVItems.darknessArrow, 5), "  *", " D ", "X  ", '*', RioVItems.ingotOfFlame, 'D', RioVItems.blackBone, 'X', RioVItems.purpleFeather);
		GameRegistry.addRecipe(new ItemStack(RioVItems.blindOasisActivator, 1), "  *", " X ", "*  ", '*', RioVItems.onyx, 'X', new ItemStack(RioVBlocks.blackQuartz, 1, 1));
		GameRegistry.addRecipe(new ItemStack(RioVBlocks.blindoniteBlock, 1), "XX", "XX", 'X', RioVItems.blindonite);
		GameRegistry.addRecipe(new ItemStack(RioVItems.vaerynActivator, 1), "  *", " X ", "*  ", '*', RioVItems.blindonite, 'X', RioVBlocks.blindoniteBlock);
		...
		GameRegistry.addRecipe(new ItemStack(RioVBlocks.glimmerwoodFenceGate, 1), "XOX", "XOX", 'X', RioVItems.glimmerwoodSticks, 'O', RioVBlocks.glimmerwoodPlanks);
		...
		GameRegistry.addRecipe(new ItemStack(RioVBlocks.cherryBlossomFenceGate, 1), "XOX", "XOX", 'O', RioVBlocks.cherryPlanks,  'X', RioVItems.cherryBlossomSticks);
		...
		GameRegistry.addRecipe(new ItemStack(RioVItems.sanctuatiteActivator, 1), "  *", " X ", "*  ", '*', RioVItems.drakiuz, 'X', RioVBlocks.blindoniteBlock);
		...
		GameRegistry.addRecipe(new ItemStack(RioVBlocks.skywoodFenceGate, 1), "XOX", "XOX", 'O', RioVBlocks.skywoodPlanks, 'X', RioVItems.skywoodSticks);
		...
		GameRegistry.addRecipe(new ItemStack(RioVItems.auntunSummoner, 1), "XTX", "TOT", "XTX", 'O', RioVItems.onyx, 'X', RioVItems.darkMatter, 'T', RioVBlocks.skycloud);
		...
		GameRegistry.addRecipe(new ItemStack(RioVItems.woodElfKingCrystal, 1), "XXX", "XAX", "XXX", 'X', RioVItems.blindonite, 'A', RioVItems.baseCrystal);
		GameRegistry.addRecipe(new ItemStack(RioVItems.altruCrystal, 1), "XMX", "MAM", "XMX", 'X', RioVItems.blindonite, 'A', RioVItems.baseCrystal, 'M', RioVItems.elfCrystal);
		GameRegistry.addRecipe(new ItemStack(RioVItems.tiTunSummoner, 1), "XMX", "MAM", "XMX", 'X', RioVItems.blindonite, 'A', RioVItems.baseCrystal, 'M', RioVItems.altruSoul);
