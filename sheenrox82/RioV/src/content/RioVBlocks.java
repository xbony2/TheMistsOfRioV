...
public class RioVBlocks 
{
	...
	public static Block blindoniteOre = new BlockCoreOne().setHardness(1.5F).setLightLevel(1.0F).setBlockName("blindoniteOre");
	...
	public static Block glimmerRock = new BlockCoreOne().setHardness(1.5F).setBlockName("glimmerRock");
	public static Block glimmerwoodDoor = new BlockRioVDoor().setHardness(1.5F).setBlockName("glimmerwoodDoor");
	public static Block glimmerwoodLadder = new BlockRioVLadder().setHardness(1.5F).setBlockName("glimmerwoodLadder");
	...
	public static Block cherryLog = new BlockCherryLog().setHardness(1.5F).setBlockName("cherryLog");
	public static Block cherryBlossomSapling = new BlockRioVSapling().setBlockName("cherryBlossomSapling");
	public static Block cherryWorkbench = new BlockRioVWorkbench().setHardness(1.5F).setBlockName("cherryWorkbench");
	public static Block cherryBlossomFence = new BlockRioVFence("cherryPlanks").setHardness(1.5F).setBlockName("cherryBlossomFence");
	public static Block cherryBlossomFenceGate = new BlockRioVFenceGate().setHardness(1.5F).setHardness(1.5F).setBlockName("cherryBlossomFenceGate");
	public static Block cherryBlossomDoor = new BlockRioVDoor().setHardness(1.5F).setHardness(1.5F).setBlockName("cherryBlossomDoor");
	public static Block cherryBlossomLadder = new BlockRioVLadder().setHardness(1.5F).setBlockName("cherryBlossomLadder");
	public static Block cherryBlossomTrapdoor = new BlockRioVTrapDoor().setHardness(1.5F).setBlockName("cherryBlossomTrapdoor");
	public static Block paleLeaf = new BlockRioVLeaf().setHardness(0.3F).setBlockName("paleLeaf");
	public static Block bloodLog = new BlockBloodLog().setHardness(1.5F).setBlockName("bloodLog");
	...
	public static Block skywoodLog = new BlockSkywoodLog().setHardness(1.5F).setBlockName("skywoodLog");
	...
	public static Block bloodDoor = new BlockRioVDoor().setHardness(1.5F).setBlockName("bloodDoor");
	public static Block bloodLadder = new BlockRioVLadder().setHardness(1.5F).setBlockName("bloodLadder");
	public static Block bloodTrapdoor = new BlockRioVTrapDoor().setHardness(1.5F).setBlockName("bloodTrapdoor");
	public static Block skywoodWorkbench = new BlockRioVWorkbench().setHardness(1.5F).setBlockName("skywoodWorkbench");
	public static Block skywoodFence = new BlockRioVFence("skywoodPlanks").setHardness(1.5F).setBlockName("skywoodFence");
	public static Block skywoodFenceGate = new BlockRioVFenceGate().setHardness(1.5F).setBlockName("skywoodFenceGate");
	public static Block skywoodDoor = new BlockRioVDoor().setHardness(1.5F).setBlockName("skywoodDoor");
	public static Block skywoodLadder = new BlockRioVLadder().setHardness(1.5F).setBlockName("skywoodLadder");
	public static Block skywoodTrapdoor = new BlockRioVTrapDoor().setHardness(1.5F).setBlockName("skywoodTrapdoor");
	public static Block alerisOre = new BlockCoreOne().setHardness(26.5F).setBlockName("alerisOre");
	public static Block anvil = new BlockAnvil().setHardness(1.5F).setBlockName("anvil");
	...
	public static Block flag = new BlockFlag().setHardness(1.5F).setBlockName("flag");
