...
public class RioVBlocks 
{
	...
	public static Block glimmerDirt = new BlockCoreOne().setStepSound(Block.soundTypeGrass).setBlockName("glimmerDirt");
	...
	public static Block bloodDirt = new BlockCoreOne().setStepSound(Block.soundTypeGrass).setBlockName("bloodDirt");
