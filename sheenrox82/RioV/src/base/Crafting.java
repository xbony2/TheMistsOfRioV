...
public class Crafting 
{
	...
	public static void add()
	{
		...
		RioVAPI.getInstance().getCraftingManager().addRecipe(new ItemStack(RioVBlocks.raetiinFlag, 1), new Object[] { flag, Character.valueOf('X'), new ItemStack(Blocks.wool, 1, 15), Character.valueOf('!'), Items.stick});
