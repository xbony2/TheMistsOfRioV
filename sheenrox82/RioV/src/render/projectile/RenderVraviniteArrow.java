...
public class RenderVraviniteArrow extends RenderArrow
{
	
	public void renderArrow(EntityVraviniteArrow entityArrow, double par2, double par4, double par6, float par8, float par9)
	{
	...
	{
		this.renderArrow((EntityVraviniteArrow)par1Entity, par2, par4, par6, par8, par9);
	}

	protected ResourceLocation getEntityTexture(EntityVraviniteArrow par1EntityArrow)
	{
		return EntityResourceLocation.vravinite_arrow;
	}

	protected ResourceLocation getEntityTexture(Entity par1Entity)
	{
		return this.getEntityTexture((EntityVraviniteArrow)par1Entity);
	}
}
