...
public class RenderTileEntitySkywoodChest extends TileEntityChestRenderer
{
	...
	public void func_147500_a(TileEntitySkywoodChest tile, double x, double y, double z, float f)
	{
		int rotation = 0;
		...
		if (tile.field_145992_i == null && tile.field_145991_k == null)
		{
			...
			if (tile.field_145990_j == null && tile.field_145988_l == null)
			{
				...
				this.func_147499_a(TileEntityResourceLocation.skywood_singleChest);
			...
			else
			{
				...
				this.func_147499_a(TileEntityResourceLocation.skywood_doubleChest);
