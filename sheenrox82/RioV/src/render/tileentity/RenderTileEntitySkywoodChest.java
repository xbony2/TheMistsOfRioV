...
public class RenderTileEntitySkywoodChest extends TileEntityChestRenderer
{
    ...
    {
        this.renderTileEntityAt((TileEntitySkywoodChest)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }

	public void renderTileEntityAt(TileEntitySkywoodChest tile, double x, double y, double z, float f)
	{
		int rotation = 0;
		if (!tile.hasWorldObj())
        {
