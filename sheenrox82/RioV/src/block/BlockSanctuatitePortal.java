...
public class BlockSanctuatitePortal extends BlockBreakable
{
	...
	{
		super(Util.MOD_ID + ":" + "sanctuatitePortal", Material.field_151567_E, false);
	}
	...
	public static class Size
	{
		...
		{
			return p_150857_1_ == RioVBlocks.sanctuatiteFire || p_150857_1_ == RioVBlocks.sanctuatitePortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.field_150867_a.func_147465_d(j, i1, k, RioVBlocks.sanctuatitePortal, this.field_150865_b, 2);
				}
			}
		}
	}
