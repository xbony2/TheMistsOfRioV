...
public class BlockRioVTrapDoor extends Block
{
    ...
    {
    	Material mat = new Material(MapColor.field_151660_b);
        if (disableValidation) return true;
        return mat.isOpaque() && p_150119_0_.func_149686_d() || p_150119_0_ == Blocks.glowstone || p_150119_0_ instanceof BlockSlab || p_150119_0_ instanceof BlockStairs;
    }
