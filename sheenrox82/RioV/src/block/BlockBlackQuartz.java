...
public class BlockBlackQuartz extends Block
{
    ...
    public void func_149651_a(IIconRegister p_149651_1_)
    {
        ...
        this.field_150190_P = p_149651_1_.registerIcon(Util.MOD_ID + "blackQuartz" + "_" + "top");
        this.field_150193_N = p_149651_1_.registerIcon(Util.MOD_ID + "blackQuartz" + "_" + "chiseled_top");
        this.field_150194_O = p_149651_1_.registerIcon(Util.MOD_ID + "blackQuartz" + "_" + "lines_top");
