...
public class BlockRioVLeaf extends BlockLeavesBase
{
	...
	{
		this.blockIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + MethodUtil.getName(this.func_149739_a()));
		this.opaqueIcon = iconRegister.registerIcon(Util.MOD_ID + ":" + MethodUtil.getName(this.func_149739_a()) + "_fast");
	}
