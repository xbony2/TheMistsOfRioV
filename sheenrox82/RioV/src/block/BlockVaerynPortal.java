	...
	public static class Size
	{
		...
		protected int func_150858_a()
		{
			...
			for (i = 0; i < this.field_150868_h; ++i)
			{
				...
				if (this.field_150867_a.func_147439_a(j, k, l) != RioVBlocks.blindoniteBlock)
				{
		...
		{
			return p_150857_1_ == RioVBlocks.whiteFire || p_150857_1_ == RioVBlocks.vaerynPortal;
		}
		...
		public void func_150859_c()
		{
			for (int i = 0; i < this.field_150868_h; ++i)
			{
				...
				for (int l = 0; l < this.field_150862_g; ++l)
				{
					...
					this.field_150867_a.func_147465_d(j, i1, k, RioVBlocks.vaerynPortal, this.field_150865_b, 2);
				}
			}
		}
	}
