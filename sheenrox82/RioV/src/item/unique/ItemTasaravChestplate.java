...
public class ItemTasaravChestplate extends ItemArmor
{
	...
	public ItemTasaravChestplate(ArmorMaterial par2EnumArmorMaterial, int par3, int par4, String armornamePrefix, boolean par5)
	{
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, int armorSlot) 
	{
		...
		if(itemStack != null)
		{
			if(itemStack.getItem() instanceof ItemTasaravChestplate)
			{
				if(type == 1 || type == 3)
				{
					armorModel = TheMistsOfRioV.commonProxy.getArmorModel(2);
				}
				else
				{
