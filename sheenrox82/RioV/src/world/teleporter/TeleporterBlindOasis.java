...
public class TeleporterBlindOasis extends Teleporter
{
            ...
            for (int l = -2; l <= 2; ++l)
            {
                for (int i1 = -2; i1 <= 2; ++i1)
                {
                    for (int j1 = -1; j1 < 3; ++j1)
                    {
                        ...
                        int i2 = k + i1 * b1 - l * b0;
                        boolean flag = j1 < 0;
                        this.worldServerInstance.func_147449_b(k1, l1, i2, flag ? RioVBlocks.blackQuartz : Blocks.air);
                    }
                }
            }
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.func_147439_a(l3, i2, l1) == RioVBlocks.blindOasisPortal)
                        {
                            while (this.worldServerInstance.func_147439_a(l3, i2 - 1, l1) == RioVBlocks.blindOasisPortal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.func_147439_a(i - 1, j, k) == RioVBlocks.blindOasisPortal)
            {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.func_147439_a(i, j, k - 1) == RioVBlocks.blindOasisPortal)
            {
                i4 = 3;
            }
            ...
            for (i3 = -1; i3 <= 1; ++i3)
            {
                for (j3 = 1; j3 < 3; ++j3)
                {
                    for (k3 = -1; k3 < 3; ++k3)
                    {
                        ...
                        j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                        flag = k3 < 0;
                        this.worldServerInstance.func_147449_b(l3, i4, j4, flag ? RioVBlocks.blackQuartz : Blocks.air);
                    }
                }
            }
        }
        ...
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServerInstance.func_147465_d(l3, i4, j4, (Block)(flag ? RioVBlocks.blackQuartz : RioVBlocks.blindOasisPortal), 0, 2);
                }
            }
