...
public class WorldGenBalance extends WorldGenerator
{
    ...
    public WorldGenBalance(Block p_i45451_1_)
    {
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        for (int l = 0; l < 4; ++l)
        {
            ...
            if (par1World.func_147437_c(i1, j1, k1) && this.field_150547_a.func_149718_j(par1World, i1, j1, k1))
            {
                par1World.func_147465_d(i1, j1, k1, this.field_150547_a, 0, 2);
            }
        }
