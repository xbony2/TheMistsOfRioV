...
public class ChunkProviderVaeryn implements IChunkProvider{
	...
	public ChunkProviderVaeryn(World var1, long var2) {
		this.worldObj = var1;
	...
	public void populate(IChunkProvider ichunkprovider, int i, int j) {
		...
		for (var13 = 0; var13 < 17; ++var13) {
			...
			(new WorldGenMinable(RioVBlocks.vraviniteOre, 9, RioVBlocks.glimmerRock)).generate(this.worldObj, this.rand, var14, var15, var16);
		}

		WorldGenGlimmerWoodTree var17 = new WorldGenGlimmerWoodTree(true);
		int var19;
		int var18;
		int var21;
		int var20;
				...
				for (int var16 = 127; var16 >= 0; --var16) {
					...
					if (var16 <= 0 + this.rand.nextInt(5)) {
						...
						if (var18 == null) {
							...
							if (var13 == -1) {
								if (var12 <= 0) {
									var14 = RioVBlocks.glimmerGrass;
									var15 = RioVBlocks.glimmerGrass;
								}
								else if (var16 >= var5 - 4 && var16 <= var5 + 1) {
									var14 = RioVBlocks.glimmerGrass;
									var15 = RioVBlocks.glimmerRock;
								}
								...
								if (var13 == 0 && var15 == RioVBlocks.glimmerGrass) {
									var13 = -1;
									var15 = RioVBlocks.glimmerGrass;
								}
							}
						...
						if (var13 > 0) {
							...
							if (var13 == 0 && var15 == RioVBlocks.glimmerRock) {
								var13 = -1;
								var15 = RioVBlocks.glimmerRock;
							}
						}
