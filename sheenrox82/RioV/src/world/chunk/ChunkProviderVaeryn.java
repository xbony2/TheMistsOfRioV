...
public class ChunkProviderVaeryn implements IChunkProvider
{
					...
					for (int l1 = 0; l1 < 8; ++l1)
					{
						...
						for (int i2 = 0; i2 < 4; ++i2)
						{
							...
							for (int k2 = 0; k2 < 4; ++k2)
							{
								if ((d16 += d15) > 0.0D)
								{
									par3ArrayOfByte[j2 += short1] = RioVBlocks.glimmerRock;
								}
								else if (k1 * 8 + l1 < b2)
								{
	...
	public void replaceBlocksForBiome(int par1, int par2, Block[] abyte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
	{
		...
		for (int var8 = 0; var8 < 16; var8++)
		{
			for (int var9 = 0; var9 < 16; var9++)
			{
				...
				float var11 = var10.getFloatRainfall();
				...
				for (int var16 = 127; var16 >= 0; var16--)
				{
					...
					{
						Block var18 = Blocks.stone;
						
						if (var18 != RioVBlocks.glimmerRock)
						{
							if (var13 == -1)
							{
								if (var12 == 0)
	...
	public Chunk provideChunk(int par1, int par2)
	{
		...
		this.caveGenerator.func_151539_a(this, this.worldObj, par1, par2, abyte);
		this.ravineGenerator.func_151539_a(this, this.worldObj, par1, par2, abyte);

		if (this.mapFeaturesEnabled)
		{
			this.scatteredFeatureGenerator.func_151539_a(this, this.worldObj, par1, par2, abyte);
		}
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		for(int x =0; x < 8; x++)
		{
			...
			(new WorldGenVaerynMineable(RioVBlocks.vraviniteOre, 4)).generate(worldObj, rand, Xcoord, Ycoord, Zcoord);
			(new WorldGenVaerynMineable(RioVBlocks.jaavikOre, 5)).generate(worldObj, rand, Xcoord, Ycoord, Zcoord);
		}
