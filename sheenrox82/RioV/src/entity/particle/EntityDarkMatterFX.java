...
public class EntityDarkMatterFX extends EntityFX 
{
    private float portalParticleScale;
    private double portalPosX, portalPosY, portalPosZ;

    public EntityDarkMatterFX(World var1, double var2, double var4, double var6, double var8, double var10, double var12) {
        ...
        this.particleBlue = 0.0F * var14;
        this.particleRed = 0.0F * var14;
        this.particleGreen = 0.0F * var14;
